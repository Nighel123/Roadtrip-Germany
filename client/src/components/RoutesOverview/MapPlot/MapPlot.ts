...
import { linearRegression } from "../../../helpers/ExtendedMath";
    ...
    Promise.all(
      roadtrips.map((roadtrip) => {
        return directionsService
          .route({
            origin: roadtrip.startAddress.town,
            destination: roadtrip.destAddress.town,
      ...
      routs.map((route, i) => {
        ...
        displayUsernameAboveEachRoute(polylinePathLR, roadtrips[i].iniUser);
      });
    });
  }
}
